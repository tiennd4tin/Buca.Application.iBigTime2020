...
{
    public class GLVoucherLastYearFacade
    {
        private readonly IGLVoucherLastYearDao glVoucherLastYearDao = new SqlServerGLVoucherLastYearDao();
        ...
        {
            return glVoucherLastYearDao.GetGLVouchers();
        }
        ...
        {
            return glVoucherLastYearDao.GetGLVouchersByRefTypeId(refTypeId);
        }

        public List<GLVoucherEntity> GetGLVoucherLastYearsByRefTypeId(int refTypeId)
        {
            return glVoucherLastYearDao.GetGLVouchersLastYearByRefTypeId(refTypeId);
        }
        /// <summary>
        ...
        {
            var glVoucher = glVoucherLastYearDao.GetGLVoucherByRefId(refId);
            if (glVoucher == null)
        ...
        public GLVoucherResponse InsertGLVoucher(GLVoucherEntity glVoucherEntity, bool isAutoGenerateParallel = false)
        {
            ...
            try
            {
                ...
                {
                    var faDepreciation = glVoucherLastYearDao.GetGLVoucher(glVoucherEntity.RefNo.Trim(), glVoucherEntity.PostedDate);
                    ...
                    response.Message = glVoucherLastYearDao.InsertGLVoucher(glVoucherEntity);
                        ...
                        foreach (var glVoucherDetail in glVoucherEntity.GLVoucherDetails)
                        {
                            ...
                            else //ghi don
                            {
                                var generalLedgerEntity = new GeneralLedgerEntity
                                {
                                    ...
                                    BudgetDetailItemCode = glVoucherDetail.BudgetDetailItemCode,
                                    CashWithDrawTypeId = glVoucherDetail.CashWithDrawTypeId,
                                    AccountNumber = glVoucherDetail.DebitAccount ?? glVoucherDetail.CreditAccount,
                    ...
                    if (!isAutoGenerateParallel)
                    {
                        ...
                        if (glVoucherEntity.GLVoucherDetailParallels != null)
                        {
                            ...
                            foreach (var glVoucherDetailParallel in glVoucherEntity.GLVoucherDetailParallels)
                            {
                                ...
                                glVoucherDetailParallel.Amount = glVoucherDetailParallel.AmountOC * exchangeRate;
                                ...
                                if (glVoucherDetailParallel.DebitAccount != null && glVoucherDetailParallel.CreditAccount != null)
                                {
                                    var generalLedgerEntity = new GeneralLedgerEntity
                                    {
                                        ...
                                        DebitAmount = glVoucherDetailParallel.AmountOC * exchangeRate,
                                    ...
                                    generalLedgerEntity.DebitAmount = 0;
                                    generalLedgerEntity.DebitAmountOC = 0;
                                    generalLedgerEntity.CreditAmount = glVoucherDetailParallel.AmountOC * exchangeRate;
                                ...
                                else
                                {
                                    var generalLedgerEntity = new GeneralLedgerEntity
                                    {
                                        ...
                                        DebitAmount = glVoucherDetailParallel.DebitAccount == null ? 0 : glVoucherDetailParallel.AmountOC * exchangeRate,
                                        DebitAmountOC = glVoucherDetailParallel.DebitAccount == null ? 0 : glVoucherDetailParallel.AmountOC,
                                        CreditAmount = glVoucherDetailParallel.CreditAccount == null ? 0 : glVoucherDetailParallel.AmountOC * exchangeRate,
                                ...
                                if (autoBusinessParallelEntitys != null)
                                {
                                    foreach (var autoBusinessParallelEntity in autoBusinessParallelEntitys)
                                    {
                                        ...
                                        var glVoucherDetailParallel = new GLVoucherDetailParallelEntity()
                                        {
                                            ...
                                            Amount = glVoucherDetail.AmountOC * exchangeRate,
                                            AmountOC = glVoucherDetail.AmountOC,
                                            BudgetSourceId =
                                        ...
                                        else
                                        {
                                            var generalLedgerEntity = new GeneralLedgerEntity
                                            {
                                                ...
                                                glVoucherDetailParallel.DebitAccount == null
                                                    ? 0
                                                    : glVoucherDetailParallel.AmountOC * exchangeRate,
                                                DebitAmountOC =
                                                glVoucherDetailParallel.DebitAccount == null
                                                    ? 0
        ...
        /// <param name="isAutoGenerateParallel">if set to <c>true</c> [is automatic generate parallel].</param>
        /// <returns>GLVoucherResponse.</returns>
        public GLVoucherResponse UpdateGlVoucher(GLVoucherEntity glVoucherEntity, bool isAutoGenerateParallel = false)
        {
            var response = new GLVoucherResponse { Acknowledge = AcknowledgeType.Success };
            try
            {
                ...
                using (var scope = new TransactionScope())
                {
                    ...
                    response.Message = glVoucherLastYearDao.UpdateGLVoucher(glVoucherEntity);
                    if (!string.IsNullOrEmpty(response.Message))
                    {
                        response.Acknowledge = AcknowledgeType.Failure;
                        return response;
        ...
        public GLVoucherResponse DeleteGLVoucher(string refId)
        {
            ...
            try
            {
                var glVoucherEntity = glVoucherLastYearDao.GetGLVoucherByRefId(refId);
                ...
                using (var scope = new TransactionScope())
                {
                    ...
                    response.Message = glVoucherLastYearDao.DeleteGLVoucher(glVoucherEntity);
                    if (!string.IsNullOrEmpty(response.Message))
                    {
                        response.Acknowledge = AcknowledgeType.Failure;
                        return response;
