...
{
    partial class FrmAutoBusinesses
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAutoBusinesses));
            ...
            this.ComponentName = "Định khoản tự động";
            this.EventTime = new System.DateTime(2018, 12, 6, 10, 56, 2, 369);
            this.FormCaption = "Định khoản tự động";
            this.FormDetail = "FrmAutoBusinessDetail";
            this.IsDisplayAddNewBarButton = true;
            this.IsDisplayDeleteBarButton = true;
            this.Name = "FrmAutoBusinesses";
            ...
            this.Reference = "THÊM ĐỊNH KHOẢN TỰ ĐỘNG - ID ";
