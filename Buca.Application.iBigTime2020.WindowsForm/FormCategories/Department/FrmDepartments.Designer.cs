namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.Department
{
    partial class FrmDepartments
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ComponentName = "Danh sách Phòng/Ban";
            this.EventTime = new System.DateTime(2018, 12, 6, 11, 12, 11, 424);
            this.ExpandAll = true;
            this.FormCaption = "Danh sách Phòng/Ban";
            this.FormDetail = "FrmDepartmentDetail";
            this.Name = "FrmDepartments";
            this.ParentFieldName = "ParentId";
            this.barToolManager.SetPopupContextMenu(this, this.popupMenu);
            this.Reference = "THÊM DANH SÁCH PHÒNG/BAN - ID ";
