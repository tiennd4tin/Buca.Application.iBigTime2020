...
{
    partial class FrmBudgetSources
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmBudgetSources));
            ...
            this.ComponentName = "Nguồn vốn";
            this.EventTime = new System.DateTime(2018, 12, 6, 11, 11, 52, 308);
            this.ExpandAll = true;
            this.FormCaption = "Nguồn vốn";
            this.FormDetail = "FrmBudgetSourceDetail";
            this.Name = "FrmBudgetSources";
            this.NamespaceForm = "namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.BudgetSource";
            this.ParentFieldName = "ParentId";
            this.barToolManager.SetPopupContextMenu(this, this.popupMenu);
            this.Reference = "THÊM NGUỒN VỐN - ID ";
