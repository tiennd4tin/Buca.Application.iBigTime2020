namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.CapitalPlan
{
    partial class FrmCapitalPlans
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmCapitalPlans));
            ...
            this.imageToobarCollection.Images.SetKeyName(8, "in.png");
            this.imageToobarCollection.Images.SetKeyName(9, "luu.png");
            this.imageToobarCollection.Images.SetKeyName(10, "nap.png");
            this.imageToobarCollection.Images.SetKeyName(11, "phan-quyen.png");
            this.imageToobarCollection.Images.SetKeyName(12, "sua.png");
            this.imageToobarCollection.Images.SetKeyName(13, "them.png");
            this.imageToobarCollection.Images.SetKeyName(14, "thoat.png");
            this.imageToobarCollection.Images.SetKeyName(15, "tim-kiem.png");
            this.imageToobarCollection.Images.SetKeyName(16, "tro-giup.png");
            this.imageToobarCollection.Images.SetKeyName(17, "xoa.png");
            this.imageToobarCollection.Images.SetKeyName(18, "dong.png");
            this.imageToobarCollection.Images.SetKeyName(19, "icon cho form danh sách-01.jpg");
            this.imageToobarCollection.Images.SetKeyName(20, "icon cho form danh sách-01.jpg");
            this.imageToobarCollection.Images.SetKeyName(21, "icon cho form danh sách-01.jpg");
            ...
            this.ComponentName = "Kế hoạch vốn";
            this.EventTime = new System.DateTime(2020, 1, 14, 15, 52, 15, 973);
            this.FormCaption = "Kế hoạch vốn";
            this.FormDetail = "FrmCapitalPlanDetail";
            this.IsDisplayAddNewBarButton = true;
            this.IsDisplayDeleteBarButton = true;
            this.Name = "FrmCapitalPlans";
            this.NamespaceForm = "Buca.Application.iBigTime2020.WindowsForm.FormCategories.CapitalPlan";
            this.barToolManager.SetPopupContextMenu(this, this.popupMenu);
            this.Reference = "THÊM KẾ HOẠCH VỐN - ID ";
            this.TablePrimaryKey = "CapitalPlanId";
