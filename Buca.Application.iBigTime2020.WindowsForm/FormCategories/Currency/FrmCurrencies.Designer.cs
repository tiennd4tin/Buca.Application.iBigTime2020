namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.Currency
{
    partial class FrmCurrencies
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.imageToobarCollection.Images.SetKeyName(19, "icon trong form danh mục chi tiết-01.jpg");
            ...
            this.ComponentName = "Danh mục tiền tệ";
            this.EventTime = new System.DateTime(2018, 12, 6, 10, 58, 41, 368);
            this.FormCaption = "Danh mục tiền tệ";
            this.FormDetail = "FrmCurrencyDetail";
            this.IsDisplayAddNewBarButton = true;
            this.IsDisplayDeleteBarButton = true;
            this.Name = "FrmCurrencies";
            this.NamespaceForm = "Buca.Application.iBigTime2020.WindowsForm.FormCategories.Currency";
            this.barToolManager.SetPopupContextMenu(this, this.popupMenu);
            this.Reference = "THÊM DANH MỤC TIỀN TỆ - ID ";
