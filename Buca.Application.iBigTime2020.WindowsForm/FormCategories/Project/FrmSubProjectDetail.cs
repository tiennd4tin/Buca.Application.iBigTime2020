...
namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.Project
{
    ...
    /// </summary>
    internal partial class FrmSubProjectDetail : FrmXtraBaseTreeDetail, IProjectView, IProjectsView, IBanksView, IAccountingObjectsView
    //, IAccountingObjectView, IBanksView, IAccountingObjectCategoriesView
    {
            ...
            set
            {
                ...
                var treeColumnsCollection = new List<XtraColumn> {
                                                ...
                                                new XtraColumn { ColumnName = "ProjectCode", ColumnCaption = "Mã CTMT/Dự án", ColumnPosition = 1, ColumnVisible = true },
                                                 ...
                                                 new XtraColumn { ColumnName = "ObjectTypeName",ColumnCaption = "Loại", ColumnPosition = 1, ColumnVisible = true },
        ...
        public string InvestmentClass
        {
            get
            {
                return txtInvestmentClass.Text.Trim();
            }
        ...
        protected override void InitData()
        {
            ...
            _projectsPresenter.DisplayByObjectType("2,3");
            if (KeyValue != null)
            {
