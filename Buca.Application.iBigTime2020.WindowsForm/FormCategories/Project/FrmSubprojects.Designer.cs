namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.Project
{
    partial class FrmSubprojects
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmSubprojects));
            ...
            this.ComponentName = "Hạng mục công trình";
            this.EventTime = new System.DateTime(2018, 12, 6, 11, 1, 19, 642);
            this.ExpandAll = true;
            this.FormCaption = "Hạng mục công trình";
            this.FormDetail = "FrmSubProjectDetail";
            this.Name = "FrmSubprojects";
            this.NamespaceForm = "Buca.Application.iBigTime2020.WindowsForm.FormCategories.Project";
            this.ParentFieldName = "ParentID";
            this.barToolManager.SetPopupContextMenu(this, this.popupMenu);
            this.Reference = "THÊM HẠNG MỤC CÔNG TRÌNH - ID ";
