namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.InventoryItem
{
    partial class FrmInventoryItems
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ComponentName = "Vật tư, hàng hóa";
            this.EventTime = new System.DateTime(2018, 12, 6, 11, 0, 29, 380);
            this.FormCaption = "Vật tư, hàng hóa";
            this.FormDetail = "FrmInventoryItemDetail";
            this.IsDisplayAddNewBarButton = true;
            this.IsDisplayDeleteBarButton = true;
            this.Name = "FrmInventoryItems";
            this.NamespaceForm = "Buca.Application.iBigTime2020.WindowsForm.FormCategories.InventoryItem";
            this.barToolManager.SetPopupContextMenu(this, this.popupMenu);
            this.Reference = "THÊM VẬT TƯ, HÀNG HÓA - ID ";
