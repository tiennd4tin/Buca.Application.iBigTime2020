...
namespace Buca.Application.iBigTime2020.WindowsForm.FormCategories.InventoryItem
{
    ...
    /// </summary>
    public partial class FrmInventoryItemDetail : FrmXtraBaseCategoryDetail, IInventoryItemView, IStocksView,
        IAccountsView, IInventoryItemCategoriesView, IAccountingObjectsView
    {
        ...
        {
            get { return txtInventoryItemCode.Text.Trim(); }
        ...
        {
            get { return txtInventoryItemName.Text.Trim(); }
        ...
        {
            get { return txtConvertUnit.Text.Trim(); }
        ...
        public decimal? UnitPrice
        {
            ...
            set { calcUnitPrice.EditValue = value == null ? null : value; }
        }
        ...
        public decimal? SalePrice
        {
            ...
            set { calcSalePrice.EditValue = value == null ? null : value; }
        }
        ...
        public IList<InventoryItemCategoryModel> InventoryItemCategories
        {
            set
            {
                var data = value.Where(o => o.InventoryItemCategoryCode.Contains("VT")).FirstOrDefault();
                vatTuId = data.InventoryItemCategoryId;
                cboInventoryCategoryId.Properties.DataSource = data;
                string text = "";
                text += cboInventoryCategoryId.EditValue;
        ...
        protected override void InitControls()
        {
            ...
            cboInventoryCategoryId.ItemIndex = 0;
        }
        ...
        protected override bool ValidData()
        {
            ...
            {
                XtraMessageBox.Show(ResourceHelper.GetResourceValueByName("ResInventoryItemName"),
                    ResourceHelper.GetResourceValueByName("ResExceptionCaption"), MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        /// <summary>
        /// Handles the Load event of the FrmXtraInventoryItemDetail control.
        /// </summary>
