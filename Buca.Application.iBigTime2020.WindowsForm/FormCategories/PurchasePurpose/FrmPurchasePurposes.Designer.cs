...
{
    partial class FrmPurchasePurposes
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmPurchasePurposes));
            ...
            this.EventTime = new System.DateTime(2018, 12, 6, 11, 1, 58, 247);
            this.FormCaption = "Nhóm hàng hóa dịch vụ";
            this.FormDetail = "FrmPurchasePurposeDetail";
            this.IsDisplayAddNewBarButton = true;
            this.IsDisplayDeleteBarButton = true;
            this.Name = "FrmPurchasePurposes";
            this.NamespaceForm = "Buca.Application.iBigTime2020.WindowsForm.FormCategories.PurchasePurpose";
            this.barToolManager.SetPopupContextMenu(this, this.popupMenu);
            this.Reference = "THÊM NHÓM HÀNG HÓA DỊCH VỤ - ID ";
            this.TablePrimaryKey = "PurchasePurposeId";
