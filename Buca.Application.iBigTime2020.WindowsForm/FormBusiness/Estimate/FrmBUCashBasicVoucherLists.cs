/***********************************************************************
 * <copyright file="FrmBUCashBasicVoucherLists.cs" company="BUCA JSC">
 * -->    Copyright (C) statement. All right reserved
 * </copyright>
 * 
 * Created:   THANGNQ
 * Email:    thangnq@buca.vn
 * Website:
 * Create Date: Thursday, September 27, 2018
 * Usage: 
 * 
 * RevisionHistory: 
...
{
    public partial class FrmBUCashBasicVoucherLists : FrmBaseVoucherList, IBUVoucherListsView, IBudgetSourcesView,
        ICashWithdrawTypesView, IAccountsView
    {
        ...
        public FrmBUCashBasicVoucherLists()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _bUVoucherListsPresenter.Display((int) RefType.BUCashBasicVoucherList);
        }
