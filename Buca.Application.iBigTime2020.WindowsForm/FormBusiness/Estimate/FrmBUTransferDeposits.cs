...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    public partial class FrmBUTransferDeposits : FrmBaseVoucherList, IBUTransfersView, IAccountsView, IBudgetChaptersView, IBudgetSourcesView, IBudgetKindItemsView, IFundStructuresView, IBanksView, IProjectsView, IBudgetItemsView, IAccountingObjectsView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmBUTransfers"/> class.
        /// </summary>
        public FrmBUTransferDeposits()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _bUTransfersPresenter.Display((int)RefType.BUTransferDeposits);
        }
        ...
        public IList<BudgetKindItemModel> BudgetKindItems
        {
            set
            {
                try
                {
                    ...
                    _gridLookUpEditBudgetKindItem = XtraColumnCollectionHelper<BudgetKindItemModel>.CreateGridLookUpEditReponsitory(_gridLookUpEditBudgetKindItemView, _budgetSubKindItemModels, "BudgetKindItemCode", "BudgetKindItemCode", gridColumnsCollection);
