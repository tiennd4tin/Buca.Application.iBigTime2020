/***********************************************************************
 * <copyright file="frmbuvoucherlists.cs" company="BUCA JSC">
 ...
 * Website:
 * Create Date: Thursday, June 7, 2018
 * Usage: 
 * 
 * RevisionHistory: 
...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    /// <seealso cref="Buca.Application.iBigTime2020.View.Estimate.IBUVoucherListsView" />
    ...
    public partial class FrmBUVoucherLists : FrmBaseVoucherList, IBUVoucherListsView, IBudgetSourcesView,
        ICashWithdrawTypesView, IAccountsView
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="FrmBUVoucherLists" /> class.
        /// </summary>
        public FrmBUVoucherLists()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _bUVoucherListsPresenter.Display((int) RefType.BUVoucherList);
        }
        ...
        protected override void LoadDataIntoGridDetail(string refId)
        {
            ...
            gridViewDetail.GridControl.Visible = false;
        }
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.BUVoucherList);
                return;
            }

            var model = (BUVoucherListModel)obj;
