...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    public partial class FrmBUTransfersPayWage : FrmBaseVoucherList, IBUTransfersView, IAccountsView, IBudgetChaptersView, IBudgetSourcesView, IBudgetKindItemsView, IFundStructuresView, IBanksView, IProjectsView, IBudgetItemsView, IAccountingObjectsView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmBUTransfers"/> class.
        /// </summary>
        public FrmBUTransfersPayWage()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _bUTransfersPresenter.Display((int)RefType.BUTransferPayWage);
        }
     ...
     new XtraColumn {ColumnName = "TopicId", ColumnVisible = false},
      new XtraColumn {ColumnName = "CashWithDrawTypeId", ColumnVisible = false},
        ...
        protected override bool ValidEdit()
        {
            ...
            var model = (BUTransferModel)item;
            string glVoucherRefNo = new GLVoucherPresenter(null).GetGLVoucherByBUTransferRefId(model.RefId);
            if (!string.IsNullOrEmpty(glVoucherRefNo))
                return XtraMessageBox.Show(string.Format("Chứng từ chuyển khoản trả lương hiện thời đã sinh chứng từ xác định lương số {0}, bạn có muốn sửa chứng từ này không?", glVoucherRefNo), ResourceHelper.GetResourceValueByName("ResDetailContent"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes ? true : false;
            return true;
        }
