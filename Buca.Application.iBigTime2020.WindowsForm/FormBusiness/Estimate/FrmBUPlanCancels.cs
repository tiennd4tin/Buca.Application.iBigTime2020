...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    /// 
    /// </summary>
    public partial class FrmBUPlanCancels : FrmBaseVoucherList, IBUPlanReceiptsView, IAccountsView, IBudgetSourcesView, IBudgetKindItemsView, IFundStructuresView, IBanksView, IProjectsView, IBudgetItemsView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmBUPlanCancels" /> class.
        /// </summary>
        public FrmBUPlanCancels()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _buPlanReceiptsPresenter.Display((int)RefType.BUPlanCancel);
        }
        ...
        public IList<BudgetItemModel> BudgetItems
        {
            set
            {
                ...
                _gridLookUpEditBudgetSubItem = XtraColumnCollectionHelper<BudgetItemModel>.CreateGridLookUpEditReponsitory(_gridLookUpEditBudgetSubItemView, budgetSubItemModels, "BudgetItemCode", "BudgetItemCode");
