...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    public partial class FrmBUTransfers : FrmBaseVoucherList, IBUTransfersView, IAccountsView, IBudgetChaptersView, IBudgetSourcesView, IBudgetKindItemsView, IFundStructuresView, IBanksView, IProjectsView, IBudgetItemsView, IAccountingObjectsView, IActivitysView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmBUTransfers"/> class.
        /// </summary>
        public FrmBUTransfers()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            //{
            //    //new RefTypeModel() {RefTypeId = (int) RefType.BUTransfer},
            //    new RefTypeModel() {RefTypeId = (int) RefType.BUTransferPurchase}
            //};
            _bUTransfersPresenter.Display();
            _activitysPresenter.DisplayActive(true);
            //_bUTransfersPresenter.Display(_listRefType);
            //_bUTransfersPresenter.Display((int)RefType.BUTransfer);
        }
        ...
        protected override void DeleteGrid()
        {
            ...
            if (new BUPlanWithdrawPresenter(null).GetBUTransferByBUTransferRefId(PrimaryKeyValue).Length > 0)
            {
                DialogResult dialog = XtraMessageBox.Show(string.Format("Bạn có muốn xóa chứng từ rút dự toán chuyển khoản số {0} không?", new BUPlanWithdrawPresenter(null).GetBUTransferByBUTransferRefId(PrimaryKeyValue)), ResourceHelper.GetResourceValueByName("ResDetailContent"), MessageBoxButtons.YesNo, MessageBoxIcon.Question);

                if (dialog == DialogResult.Yes)
                {
                    new BUPlanWithdrawPresenter(null).DeleteBUTransferByBUTransferRefId(PrimaryKeyValue);
                }
            }
        }
        ...
        protected override void LoadDataIntoGridDetail(string refId)
        {
            ...
            if (buTransfer == null)
                return;
            this.RefTypeId = this.RefTypeId == 0 ? RefType.BUTransfer : this.RefTypeId;
            switch (this.RefTypeId)
            {
                case RefType.BUTransfer:
                    bindingSourceDetail.DataSource = buTransfer.BUTransferDetails;
                    gridViewDetail.PopulateColumns(buTransfer.BUTransferDetails);
                    break;
                case RefType.BUTransferPurchase:
                    bindingSourceDetail.DataSource = buTransfer.BUTransferDetailPurchases;
                     ...
                     new XtraColumn
            {
                ...
                RepositoryControl = _gridLookUpEditActivity
                        ...
                        AllowEdit = false},
                            ...
                            new XtraColumn {ColumnName = "CashWithdrawTypeName", ColumnVisible = true,
                        RepositoryControl = _gridLookUpEditFundStructure,
                        ColumnWith = 130,
     ...
     new XtraColumn {ColumnName = "TopicId", ColumnVisible = false},
      new XtraColumn {ColumnName = "CashWithDrawTypeId", ColumnVisible = false},
                ...
                new XtraColumn {ColumnName = "AdvanceRecovery", ColumnVisible = false},
            };
            ...
            {
                case RefType.BUTransfer:
                    XtraColumnCollectionHelper<BUTransferDetailModel>.ShowXtraColumnInGridView(columnsCollection, gridViewDetail);
                    break;
                case RefType.BUTransferPurchase:
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.BUTransfer);
                return;
            }
            var model = (BUTransferModel)obj;
        ...
        public IList<BUTransferModel> BUTransfers
        {
            set
            {
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BankInfoId", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "AccountingObjectId", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "AccountingObjectName", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "AccountingObjectAddress", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "AccountingObjectBankAccount", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "AccountingObjectBankName", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "DocumentIncluded", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "InwardStockRefNo", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "WithdrawRefDate", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "WithdrawRefNo", ColumnVisible = false });
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "TotalFixedAssetAmount", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BUTransferDetails", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BUTransferDetailParallel", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BUTransferDetailPurchases", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BUTransferDetailFixedAssets", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BUPlanWithdrawRefId", ColumnVisible = false });
                //ColumnsCollection.Add(new XtraColumn { ColumnName = "Parallels", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "gLVouchersRefId", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "LinkRefNo", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BUTransferRefID", ColumnVisible = false });





                //ColumnsCollection.Add( new XtraColumn { ColumnName = "BUCommitmentRequestDetails", ColumnVisible = false });
