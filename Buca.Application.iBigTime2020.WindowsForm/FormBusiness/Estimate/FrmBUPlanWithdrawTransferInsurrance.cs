...
{
    /// <summary>
    /// Class FrmBUPlanWithdrawTransferInsurrance.
    /// </summary>
    public partial class FrmBUPlanWithdrawTransferInsurrance : FrmBaseVoucherList, IBUPlanWithdrawTransferInsurrancesView, ICashWithdrawTypesView, IProjectsView,
        IBudgetSourcesView, IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, IFundStructuresView
    {
        ...
        private readonly BUPlanWithdrawTransferInsurrancesPresenter _planWithdrawTransferInsurrancesPresenter;
        ...
        /// </summary>
        public FrmBUPlanWithdrawTransferInsurrance()
        {
            InitializeComponent();

            _planWithdrawTransferInsurrancesPresenter = new BUPlanWithdrawTransferInsurrancesPresenter(this);
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _planWithdrawTransferInsurrancesPresenter.DisplayByRefType((int)BuCA.Enum.RefType.BUPlanWithdrawTransferInsurrance);
        }
        ...
        protected override void DeleteGrid()
        {
            ...
            var buTranser = Model.GetBUTransferByBUPlanWithdrawRefId(PrimaryKeyValue);
            if (buTranser != null)
            {
        ...
        protected override bool ValidEdit()
        {
            ...
            if (item == null)
                return false;
            //Lấy ID chứng từ Chuyển khoản kho bạc trả lương có liên kết
            var model = (BUPlanWithdrawModel)item;
            var buTransfers = Model.GetBUTransferByBUPlanWithdrawRefId(model.RefId);
            if (buTransfers != null)
        ...
        #region IBUTransferView
        public IList<BUTransferModel> BUTransfers { get; set; }
