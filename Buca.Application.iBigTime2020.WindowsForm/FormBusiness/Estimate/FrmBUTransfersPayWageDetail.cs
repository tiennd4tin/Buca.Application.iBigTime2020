...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    public partial class FrmBUTransfersPayWageDetail : FrmXtraBaseVoucherDetail, IBUTransferPayWageView, ICashWithdrawTypesView,
        ...
        , IAccountsView, IBudgetItemsView, IProjectsView, IFundStructuresView, IBanksView, IAccountingObjectsView, IActivitysView, IBudgetExpensesView
    {
        ...
        /// </summary>
        public FrmBUTransfersPayWageDetail()
        {
            InitializeComponent();
        ...
        protected override void InitData()
        {
            ...
            if (RefType == 0)
            {
                RefType = (int)BuCA.Enum.RefType.BUTransferPayWage;
                Posted = true;
        ...
        protected override void DeleteVoucher()
        {
            ...
            if (refNo.Length > 0)
            {
                DialogResult dialog = XtraMessageBox.Show(string.Format("Bạn có muốn xóa chứng từ chung khoản số {0} không?", refNo), ResourceHelper.GetResourceValueByName("ResDetailContent"), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            if (!string.IsNullOrEmpty(sResult))
            {
                ...
                switch (ActionMode)
                {
                    case ActionModeVoucherEnum.AddNew:
                        dialog = XtraMessageBox.Show("Bạn có muốn sinh chứng từ xác định lương tại chứng từ chung không?", ResourceHelper.GetResourceValueByName("ResDetailContent"), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                        break;
                    case ActionModeVoucherEnum.Edit:
                        if (!string.IsNullOrEmpty(glVoucherRefNo))
                            ...
                            dialog = XtraMessageBox.Show("Bạn có muốn đồng bộ các thông tin đã cập nhật trên giấy rút với chứng từ chung?", ResourceHelper.GetResourceValueByName("ResDetailContent"), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                        else
                            dialog = XtraMessageBox.Show("Bạn có muốn sinh chứng từ xác định lương tại chứng từ chung không?", ResourceHelper.GetResourceValueByName("ResDetailContent"), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                        break;
                }
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    {
                        //m.DebitAccount = _defaultDebitAccount.AccountNumber; tạm phải fix cứng @@
                        m.DebitAccount = "61111";
                        m.CreditAccount = "3341"; // fix
                        m.AccountingObjectId = AccountingObjectId;
                        m.CreditAccountingObjectId = AccountingObjectId;
                        return m;
                    }).ToList();
        ...
        /// <summary>
        /// Gets or sets the g l vouchers reference identifier.
        /// </summary>
        /// <value>
        /// The g l vouchers reference identifier.
        /// </value>
        public string gLVouchersRefId { get; set; }

        /// <summary>
        /// Gets or sets the link reference no.
        /// </summary>
        /// <value>
        /// The link reference no.
        /// </value>
        ...
        protected override bool ValidEdit()
        {
            string glVoucherRefNo = new GLVoucherPresenter(null).GetGLVoucherByBUTransferRefId(RefId);
            if (!string.IsNullOrEmpty(glVoucherRefNo))
                return XtraMessageBox.Show(string.Format("Chứng từ chuyển khoản trả lương hiện thời đã phát sinh chứng từ chung số {0}, bạn có muốn sửa chứng từ chuyển khoản trả lương này không?", glVoucherRefNo), ResourceHelper.GetResourceValueByName("ResDetailContent"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes ? true : false;
            return true;
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="FrmBUTransfersPayWageDetail"/> is approved.
        /// </summary>
        /// <value>
...
new XtraColumn
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmBUTransfersPayWageDetail_Load(object sender, EventArgs e)
        {
        ...
        private void FrmBUTransfersPayWageDetail_Resize(object sender, EventArgs e)
        {
