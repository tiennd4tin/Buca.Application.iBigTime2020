...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    public partial class FrmBUCommitmentRequests : FrmBaseVoucherList, IBUCommitmentRequestsView, IAccountsView, IBudgetChaptersView, IBudgetSourcesView, IBudgetKindItemsView, IFundStructuresView, IBanksView, IProjectsView, IBudgetItemsView, IAccountingObjectsView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmBUCommitmentRequests"/> class.
        /// </summary>
        public FrmBUCommitmentRequests()
        {
            InitializeComponent();
        ...
        {
            new BUCommitmentRequestPresenter(null).Delete(PrimaryKeyValue);
        }
        ...
        {
            var buCommitmentRequest = _model.GetBUCommitmentRequestVoucher(refId, true);
            if (buCommitmentRequest == null)
                return;
            bindingSourceDetail.DataSource = buCommitmentRequest.BUCommitmentRequestDetails;
            gridViewDetail.PopulateColumns(buCommitmentRequest.BUCommitmentRequestDetails);
            ...
            XtraColumnCollectionHelper<BUCommitmentRequestDetailModel>.ShowXtraColumnInGridView(columnsCollection, gridViewDetail);
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.BUCommitmentRequest);
                return;
            }

            var model = (BUCommitmentRequestModel)obj;
