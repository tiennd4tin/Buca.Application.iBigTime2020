...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Estimate
{
    ...
    public partial class FrmBUTransfersPayInsurrance : FrmBaseVoucherList, IBUTransfersView, IAccountsView, IBudgetChaptersView, IBudgetSourcesView, IBudgetKindItemsView, IFundStructuresView, IBanksView, IProjectsView, IBudgetItemsView, IAccountingObjectsView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmBUTransfers"/> class.
        /// </summary>
        public FrmBUTransfersPayInsurrance()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _bUTransfersPresenter.Display((int)RefType.BUTransferPayInsurrance);
        }
        ...
        protected override void DeleteGrid()
        {
            ...
            string refNo = new GLVoucherPresenter(null).GetGLVoucherByBUTransferRefId(PrimaryKeyValue);
            if (refNo.Length > 0)
            {
                ...
                {
                    new GLVoucherPresenter(null).DeleteGLVoucherByBUTransferRefId(PrimaryKeyValue);
                }
            }
        }
     ...
     new XtraColumn {ColumnName = "TopicId", ColumnVisible = false},
      new XtraColumn {ColumnName = "CashWithDrawTypeId", ColumnVisible = false},
        ...
        protected override bool ValidEdit()
        {
            ...
            var model = (BUTransferModel)item; string glVoucherRefNo = new GLVoucherPresenter(null).GetGLVoucherByBUTransferRefId(model.RefId);
