...
{
    public partial class FrmBUCashBasicVoucherListDetail : FrmXtraBaseVoucherDetail, IBUVoucherListView, IBudgetSourcesView,
        IProjectsView, ICashWithdrawTypesView, IBudgetExpensesView
    {
        public FrmBUCashBasicVoucherListDetail()
        {
            InitializeComponent();
        ...
        protected override void InitData()
        {
            ...
            if (RefType == 0)
            {
                RefType = (int)BuCA.Enum.RefType.BUCashBasicVoucherList;
        ...
        private void btnSelectVoucher_Click(object sender, EventArgs e)
        {
            ...
            using (var frmParam = new FrmBUVoucherListDetailParameter(FromDate, ToDate, BUVoucherListDetailModels, "04"))
            {
            ...
            try
            {
                ...
                switch (item.VoucherRefType)
                {
                    ...
                    case (int)BuCA.Enum.RefType.GLVoucher: //401
                        frmDetail = new General.FrmGLVoucherDetail();
                        break;
