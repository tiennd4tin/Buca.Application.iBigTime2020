...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.IncrementDecrement
{
    ...
    public partial class FrmFADecrements : FrmBaseVoucherList, IFAIncrementDecrementsView, IFixedAssetsView,
        IDepartmentsView, IAccountsView, IAccountingObjectsView,
        IBudgetSourcesView, IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmFADecrements" /> class.
        /// </summary>
        public FrmFADecrements()
        {
            InitializeComponent();
        ...
        #region IFAIncrementDecrementsView
        ...
        /// </value>
        public IList<FAIncrementDecrementModel> FAIncrementDecrements
        {
            set
            {
                ...
                ColumnsCollection.Add(
                    new XtraColumn { ColumnName = "FAIncrementDecrementDetails", ColumnVisible = false });
            }
        }
        ...
        /// </summary>
        private readonly FAIncrementDecrementsPresenter _fAIncrementDecrementsPresenter;
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _fAIncrementDecrementsPresenter.Display((int)RefType.FADecrement);
        }
        ...
        {
            var sAIncrementDecrement = _model.GetFAIncrementDecrement(refId, true);
            if (sAIncrementDecrement == null)
                return;
            bindingSourceDetail.DataSource = sAIncrementDecrement.FAIncrementDecrementDetails;
            gridViewDetail.PopulateColumns(sAIncrementDecrement.FAIncrementDecrementDetails);
 ...
 new XtraColumn
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.FADecrement);
                return;
            }

            var model = (FAIncrementDecrementModel)obj;
