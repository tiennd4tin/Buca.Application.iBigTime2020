/***********************************************************************
 * <copyright file="FrmINOutwards.cs" company="BUCA JSC">
...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.Inventory
{
    ...
    public partial class FrmINOutwards : FrmBaseVoucherList, IINInwardOutwardsView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,IInventoryItemsView,
        IFundStructuresView
    {
        /// <summary>
        /// The i n inward outwards presenter
        /// </summary>
        private readonly INInwardOutwardsPresenter _iNInwardOutwardsPresenter;
        /// <summary>
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _iNInwardOutwardsPresenter.DisplayByRefType(202);
        }
        ...
        {
            var inOutWardModel = Model.GetINInwardOutward(refId, true,true);
            if (inOutWardModel == null)
                bindingSourceDetail.DataSource = null;
            else
            {
                bindingSourceDetail.DataSource = inOutWardModel.InwardOutwardDetails;
                gridViewDetail.PopulateColumns(inOutWardModel.InwardOutwardDetails);
        ...
        {
            new INInwardOutwardPresenter(null).Delete(PrimaryKeyValue);
        }
        ...
        public IList<INInwardOutwardModel> INInwardOutwards
        {
            set
            {
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "InwardOutwardDetails", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "DocumentInclued", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "InwardOutwardDetailParallels", ColumnVisible = false });
        ...
        public IList<InventoryItemModel> InventoryItems
        {
            set
            {
                var columnsCollection = new List<XtraColumn>
                {
                    ...
                    new XtraColumn {ColumnName = "ConvertUnit", ColumnVisible = false},
                    new XtraColumn {ColumnName = "ConvertRate", ColumnVisible = false},
                    new XtraColumn {ColumnName = "UnitPrice", ColumnVisible = false},
                    new XtraColumn {ColumnName = "SalePrice", ColumnVisible = false},
                    new XtraColumn {ColumnName = "DefaultStockId", ColumnVisible = false},
                    new XtraColumn {ColumnName = "InventoryAccount", ColumnVisible = false},
                    new XtraColumn {ColumnName = "COGSAccount", ColumnVisible = false},
                    new XtraColumn {ColumnName = "SaleAccount", ColumnVisible = false},
                    new XtraColumn {ColumnName = "CostMethod", ColumnVisible = false},
                    new XtraColumn {ColumnName = "AccountingObjectId", ColumnVisible = false},
                    new XtraColumn {ColumnName = "TaxRate", ColumnVisible = false},
                    new XtraColumn {ColumnName = "IsTool", ColumnVisible = false},
                    new XtraColumn {ColumnName = "IsService", ColumnVisible = false},
                    new XtraColumn {ColumnName = "IsActive", ColumnVisible = false},
                    new XtraColumn {ColumnName = "IsTaxable", ColumnVisible = false},
                };
                #region Lookup edit accounting objects
                ...
                _gridLookUpEditInventoryItem.DisplayMember = "InventoryItemName";
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.INOutward);
                return;
            }

            var model = (INInwardOutwardModel)obj;
