...
{
    public partial class FrmBAWithDrawPurchases : FrmBaseVoucherList, IBAWithDrawsView, IAccountingObjectsView, IBanksView, IAccountsView, IBudgetSourcesView, IFundStructuresView,
        IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IInventoryItemsView, IPurchasePurposesView, IStocksView
    {
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _purchasePurposesPresenter.Display();
            _stocksPresenter.Display();
            _bAWithDrawsPresenter.Display(158);
        }
        ...
        protected override void LoadDataIntoGridDetail(string refId)
        {
            if (refId != null)
            {
                ...
                var bAWithDraw = Model.GetBAWithDraw(refId, false, false, true, false, false);
