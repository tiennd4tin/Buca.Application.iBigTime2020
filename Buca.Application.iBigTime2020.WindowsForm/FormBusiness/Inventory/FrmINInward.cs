...
{
    public partial class FrmINInward : FrmBaseVoucherList, IINInwardOutwardsView, IAccountingObjectsView,
        IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView,
        IProjectsView, IStocksView, IInventoryItemsView,
        IFundStructuresView
    {
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _inInwardOutwardsPresenter.DisplayByRefType(201);
        }
        ...
        public IList<INInwardOutwardModel> INInwardOutwards
        {
            ...
            {
                if (value == null)
                    bindingSource.DataSource = new List<INInwardOutwardModel>();
                else
        ...
        {
            var inInwardModel = Model.GetINInwardOutward(refId, true, false);
            if (inInwardModel == null)
                inInwardModel = new INInwardOutwardModel();

            bindingSourceDetail.DataSource = inInwardModel.InwardOutwardDetails;
            gridViewDetail.PopulateColumns(inInwardModel.InwardOutwardDetails);
            ...
            XtraColumnCollectionHelper<INInwardOutwardDetailModel>.ShowXtraColumnInGridView(columnsCollection, gridViewDetail);
