...
{
    public partial class FrmCAPaymentTreasuries : FrmBaseVoucherList, ICAPaymentsView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        ...
        IFundStructuresView
    {
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _paymentsPresenter.Display((int)RefType.CAPaymentTreasury);
        }
        ...
        protected override void LoadDataIntoGridDetail(string refId)
        {
            ...
            var columnsCollection = new List<XtraColumn>
            {
                ...
                new XtraColumn {ColumnName = "AmountOC",ColumnVisible = true,ColumnWith = 100,ColumnCaption = "Số tiền",ColumnPosition = 4,IsSummnary = true,AllowEdit = true,ColumnType = UnboundColumnType.Decimal},
                new XtraColumn {ColumnName = "Amount",ColumnVisible = true,ColumnWith = 100,ColumnCaption = "Số tiền quy đổi",ColumnPosition = 5,IsSummnary = true,AllowEdit = true,ColumnType = UnboundColumnType.Decimal},
                new XtraColumn {ColumnName = "BudgetSourceId",ColumnVisible = true,ColumnWith = 150,ColumnCaption = "Nguồn",ColumnPosition = 6,AllowEdit = true,RepositoryControl = _gridLookUpEditBudgetSource},
                new XtraColumn {ColumnName = "BudgetChapterCode",ColumnVisible = true,ColumnWith = 80,ColumnCaption = "Chương",ColumnPosition = 7,AllowEdit = true,RepositoryControl = _gridLookUpEditBudgetChapter},
                new XtraColumn {ColumnName = "BudgetKindItemCode", ColumnVisible = false}, //chon thang subkinditem la ra kinditem
                new XtraColumn {ColumnName = "BudgetSubKindItemCode",ColumnVisible = true,ColumnWith = 80,ColumnCaption = "Khoản",ColumnPosition = 8,AllowEdit = true,RepositoryControl = _gridLookUpEditBudgetSubKindItem},
                new XtraColumn {ColumnName = "BudgetSubItemCode",ColumnVisible = true,ColumnWith = 80,ColumnCaption = "Tiểu mục",ColumnPosition = 9,AllowEdit = true,RepositoryControl = _gridLookUpEditBudgetSubItem},
                new XtraColumn {ColumnName = "BudgetItemCode",ColumnVisible = true,ColumnWith = 80,ColumnCaption = "Mục",ColumnPosition = 10,AllowEdit = true,RepositoryControl = _gridLookUpEditBudgetItem},
                new XtraColumn {ColumnName = "MethodDistributeId",ColumnVisible = true,ColumnWith = 120,ColumnCaption = "Cấp phát",ColumnPosition = 11,AllowEdit = true,RepositoryControl = _repositoryMethodDistributeId},
                new XtraColumn {ColumnName = "CashWithDrawTypeId",ColumnVisible = true,ColumnWith = 120,ColumnCaption = "Nghiệp vụ",ColumnPosition = 12,AllowEdit = true,RepositoryControl = _gridLookUpEditCashWithdrawType},
                ...
                new XtraColumn {ColumnName = "FundStructureId",ColumnVisible = true,ColumnWith = 120,ColumnCaption = "Cơ cấu vốn",ColumnPosition = 11,AllowEdit = true,RepositoryControl = _gridLookUpEditFundStructure},
                new XtraColumn {ColumnName = "BankId",ColumnVisible = true,ColumnWith = 100,ColumnCaption = "Ngân hàng",ColumnPosition = 12,AllowEdit = true,RepositoryControl = _gridLookUpEditBank, IsLastColumn = true},
        ...
        public IList<CAPaymentModel> CAPayments
        {
            set
            {
                ...
                ColumnsCollection.Add(new XtraColumn
                {
                    ...
                    ColumnVisible = false
                }); // Cột này là số tiền nguyên tệ, nhưng cần hiển thị số tiền quy đổi cho nhiều loại tiền nên ẩn đi
                ColumnsCollection.Add(new XtraColumn
                {
                    ...
                    ColumnWith = 40
                });// Cột này là số tiền quy đổi, nhưng cần hiển thị số tiền quy đổi cho nhiều loại tiền nên cho hiển thị
                ColumnsCollection.Add(new XtraColumn
                {
                    ColumnName = "RefType",
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "TotalAmount", ColumnVisible = false });
