/***********************************************************************
 * <copyright file="FrmCAReceiptEstimateDetail.cs" company="BUCA JSC">
...
{
    /// <summary>
    /// Phiếu thu từ ngân sách nhà nước
    /// </summary>
    public partial class FrmCAReceiptEstimateDetail : FrmXtraBaseVoucherDetail, IAccountingObjectsView, ICAReceiptView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
        IFundStructuresView, IPurchasePurposesView, IBudgetExpensesView
    {
        ...
        /// </summary>
        public List<CAReceiptDetailModel> ListSendSourceDetail;
        public bool IsOpenFromBUPlanWithdrawCashDetail;
        ...
        /// </summary>
        public FrmCAReceiptEstimateDetail()
        {
            InitializeComponent();
        ...
        {
            grdMaster.Location = new Point(6, 215);
            tabMain.Location = new Point(6, 275);
        ...
        protected override void InitData()
        {
            ...
            if (RefType == 0)
                RefType = (int)BuCA.Enum.RefType.CAReceiptEstimate;
            if (RefId == null)
            {
                dateInvDateOrWithdrawRefDate.EditValue = DateTime.Now;
            }

            if (IsOpenFromBUPlanWithdrawCashDetail && bUPlanWithdrawModel != null)
            {
                IsOpenFromBUPlanWithdrawCashDetail = false;
                ...
                ExchangeRate = (decimal)bUPlanWithdrawModel.ExchangeRate;
        ...
        protected override bool ValidData()
        {
            ...
            // Bỏ kiểm tra người nhận - người thu
            ...
            //    return false;
            //}
            if (!string.IsNullOrEmpty(RefNo) && _caReceiptPresenter.RefNoIsExist(KeyValue, RefNo, 105))
            {
                XtraMessageBox.Show(string.Format(ResourceHelper.GetResourceValueByName("ResRefNoCAReceiptDuplicate"), RefNo),
                    ResourceHelper.GetResourceValueByName("ResNotice"), MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtRefNo.Text = "";
                txtRefNo.Focus();
                return false;
            }
            ...
            if (dateInvDateOrWithdrawRefDate.EditValue == null)
            {
                XtraMessageBox.Show(ResourceHelper.GetResourceValueByName("dateInvDateOrWithdrawRefDate"), detailContent, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dateInvDateOrWithdrawRefDate.Focus();
                return false;

            }

            // Không bắt buộc nhập giấy rút
            //if (string.IsNullOrEmpty(InvNoOrWithdrawRefNo))
            //{
            //    XtraMessageBox.Show(ResourceHelper.GetResourceValueByName("ResReceiptInvNoOrWithdrawRefNo"), detailContent,
            //        MessageBoxButtons.OK, MessageBoxIcon.Error);
            //    txtRefNo.Focus();
            //    return false;
            //}
            ...
            if (CAReceiptDetails.Count > 0)
            {
                foreach (CAReceiptDetailModel voucher in CAReceiptDetails)
                {
                    if (voucher.DebitAccount == null)
                    {
                    ...
                    {
                        XtraMessageBox.Show(ResourceHelper.GetResourceValueByName("ResAmountOc"),
        ...
        {
            this.RefId = new CAReceiptPresenter(null).Delete(KeyValue);
        }
        ...
        {
            get { return txtInvNoOrWithdrawRefNo.EditValue == null ? "" : txtInvNoOrWithdrawRefNo.EditValue.ToString(); }
        ...
        /// </summary>
        /// <value>
        ///   <c>true</c> if posted; otherwise, <c>false</c>.</value>
        ...
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is attach list; otherwise, <c>false</c>.</value>
        ...
        public List<CAReceiptDetailModel> CAReceiptDetails
        {
            ...
            set
            {
                ...
                if (IsOpenFromBUPlanWithdrawCashDetail)
                {
        ...
        private void FrmCAReceiptEstimateDetail_Resize(object sender, EventArgs e)
        {
        ...
        private void FrmCAReceiptEstimateDetail_Load(object sender, EventArgs e)
        {
