...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.IncrementDecrement
{
    ...
    /// FrmSUDecrements
    /// </summary>
    public partial class FrmSUDecrements : FrmBaseVoucherList, ISUIncrementDecrementsView, IInventoryItemsView,
        IDepartmentsView, IAccountsView, IAccountingObjectsView,
        IBudgetSourcesView, IBudgetChaptersView, IBudgetKindItemsView
    {
        public FrmSUDecrements()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _suIncrementDecrementsPresenter.Display((int)RefType.SUDecrement);
        }
