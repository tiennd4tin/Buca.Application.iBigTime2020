...
{
    /// <summary>
    ///     FrmSUIncrementDecrements
    /// </summary>
    /// <seealso cref="Buca.Application.iBigTime2020.WindowsForm.FormBase.FormList.FrmBaseVoucherList" />
    /// <seealso cref="Buca.Application.iBigTime2020.View.IncrementDecrement.ISUIncrementDecrementsView" />
    ...
    public partial class FrmSUIncrements : FrmBaseVoucherList, ISUIncrementDecrementsView, IInventoryItemsView,
        IDepartmentsView, IAccountsView, IAccountingObjectsView,
        IBudgetSourcesView, IBudgetChaptersView, IBudgetKindItemsView
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="FrmSUIncrements" /> class.
        /// </summary>
        public FrmSUIncrements()
        {
            InitializeComponent();
        ...
        #region ISUIncrementDecrementsView
        ...
        public IList<SUIncrementDecrementModel> SUIncrementDecrementModels
        {
            set
            {
                ...
                ColumnsCollection.Add(
                    new XtraColumn {ColumnName = "SUIncrementDecrementDetails", ColumnVisible = false});
            }
        }
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _sUIncrementDecrementsPresenter.Display((int)RefType.SUIncrement);
        }
        ...
        {
            new SUIncrementDecrementPresenter(null).Delete(PrimaryKeyValue);
        }
        ...
        {
            var sUIncrementDecrement = _model.GetSUIncrementDecrement(refId, true);

            bindingSourceDetail.DataSource = sUIncrementDecrement.SUIncrementDecrementDetails;
            gridViewDetail.PopulateColumns(sUIncrementDecrement.SUIncrementDecrementDetails);
            ...
            gridViewDetail.Columns["BudgetSubKindItemCode"].BestFit();
            gridViewDetail.Columns["AccountingObjectId"].BestFit();
            gridViewDetail.Columns["Description"].BestFit();
