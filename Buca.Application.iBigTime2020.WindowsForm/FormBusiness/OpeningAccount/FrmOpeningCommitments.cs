...
{
    /// <summary>
    /// Class FrmOpeningCommitments.
    /// </summary>
    /// <seealso cref="Buca.Application.iBigTime2020.WindowsForm.FormBase.FormList.FrmBaseVoucherList" />
    /// <seealso cref="Buca.Application.iBigTime2020.View.Estimate.IOpeningCommitmentsView" />
    ...
    public partial class FrmOpeningCommitments : FrmBaseVoucherList, IOpeningCommitmentsView, IAccountsView, IBudgetChaptersView, IBudgetSourcesView, IBudgetKindItemsView, IFundStructuresView, IBanksView, IProjectsView, IBudgetItemsView, IAccountingObjectsView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrmOpeningCommitments"/> class.
        /// </summary>
        public FrmOpeningCommitments()
        {
            InitializeComponent();
            _openingCommitmentsPresenter = new OpeningCommitmentsPresenter(this);
        ...
        /// </summary>
        private readonly OpeningCommitmentsPresenter _openingCommitmentsPresenter;
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _openingCommitmentsPresenter.Display();
        ...
        {
            new OpeningCommitmentPresenter(null).Delete(PrimaryKeyValue);
        }
        ...
        {
            var openingCommitment = _model.GetOpeningCommitmentVoucher(refId, true);
            if (openingCommitment == null)
                return;
            bindingSourceDetail.DataSource = openingCommitment.OpeningCommitmentDetails;
            gridViewDetail.PopulateColumns(openingCommitment.OpeningCommitmentDetails);
                         ...
                         new XtraColumn
            {
               ...
               ColumnType = UnboundColumnType.Decimal
                    ...
                    new XtraColumn {ColumnName = "BankAccount", ColumnVisible = true,
        ...
        public IList<OpeningCommitmentModel> OpeningCommitments
        {
            set
            {
                var openingCommitmentModel = value;
                bindingSource.DataSource = (openingCommitmentModel);
                gridView.PopulateColumns(openingCommitmentModel);
                ...
                ColumnsCollection.Add(new XtraColumn
                {
                    ...
                    ColumnCaption = "Ngày đề nghị CKC",
                    ColumnType = UnboundColumnType.DateTime,
                    ColumnPosition = 2,
                    ColumnVisible = true,
                    Alignment = HorzAlignment.Center,
                ...
                ColumnsCollection.Add(new XtraColumn
                {
                    ColumnName = "TotalAmount", //ColumnName = "TotalAmountOC",
                    ColumnCaption = "Số tiền",
                    ColumnPosition = 8,
                    ColumnVisible = true,
                    ColumnType = UnboundColumnType.Decimal,
                ...
                ColumnsCollection.Add(new XtraColumn
                {
                    ColumnName = "IsForeignCurrency",
                    ColumnCaption = "Có phát sinh ngoại tệ",
                    ColumnPosition = 9,
                    ColumnVisible = true,
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "TABMISCode", ColumnVisible = false });
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BudgetSourceKind", ColumnVisible = false });
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "ProjectInvestmentCode", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "ProjectInvestmentName", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "ContractAmount", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "PrevYearCommitmentAmount", ColumnVisible = false });



                ColumnsCollection.Add(
                    new XtraColumn { ColumnName = "OpeningCommitmentDetails", ColumnVisible = false });
            }
        }
