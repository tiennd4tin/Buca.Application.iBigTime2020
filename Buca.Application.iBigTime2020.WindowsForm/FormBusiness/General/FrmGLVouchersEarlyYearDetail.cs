...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.General
{
    ...
    /// <seealso cref="Buca.Application.iBigTime2020.View.General.IGLVoucherEarlyYearView" />
    ...
    public partial class FrmGLVouchersEarlyYearDetail : FrmXtraBaseVoucherDetail, IGLVoucherEarlyYearView, IAccountingObjectsView,
                                              IBudgetSourcesView, IAccountsView, IContractsView,
                                              IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, IGLVouchersEarlyYearView,
                                              ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
                                              IFundStructuresView, IPurchasePurposesView,
                                              IInvoiceTypiesView, IBudgetExpensesView
    {
        #region Presenter

        private readonly BudgetExpensesPresenter _budgetExpensesPresenter;
        private readonly GLVoucherEarlyYearPresenter _glVoucherEarlyYearPresenter;
        ...
        /// </summary>
        public FrmGLVouchersEarlyYearDetail()
        {
            InitializeComponent();
            ...
            _glVoucherEarlyYearPresenter = new GLVoucherEarlyYearPresenter(this);
        ...
        /// <summary>
        /// Handles the Load event of the FrmGLVouchersEarlyYearDetail control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void FrmGLVouchersEarlyYearDetail_Load(object sender, EventArgs e)
        {
            RefTypeUsingDisplayReport = BuCA.Enum.RefType.GLVoucherEarlyYear;
        ...
        {
            _glVouchersPresenter.Display((int)BuCA.Enum.RefType.GLVoucherEarlyYear);
            ...
            if (ActionMode != ActionModeVoucherEnum.AddNew) _glVoucherEarlyYearPresenter.Display(KeyValue, true, true);
            if (RefType == 0)
                RefType = (int)BuCA.Enum.RefType.GLVoucherEarlyYear;
        }
        ...
        protected override void InitDetailRow(InitNewRowEventArgs e, GridView view)
        {
            try
            {
                view.SetRowCellValue(e.RowHandle, "CashWithDrawTypeId", 26);//AnhNT: Set = 26 là nghiệp vụ quyết toán, phần này của riêng chứng từ => cần phải set cứng.
            }
            catch (Exception ex)
            {
        ...
        protected override string SaveData()
        {
            ...
            return result == DialogResult.OK ? _glVoucherEarlyYearPresenter.Save(true) : _glVoucherEarlyYearPresenter.Save(false);
        }
        ...
        {
            _glVoucherEarlyYearPresenter.Display(KeyValue, true, true);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="FrmGLVouchersEarlyYearDetail"/> is approved.
        /// </summary>
        /// <value>
...
new XtraColumn
        ...
        private void btSelectProject_Click(object sender, EventArgs e)
        {
            ...
            if (frmSelectProject.DialogResult == DialogResult.OK)
            {
                ...
                {
                    _glVoucherEarlyYearPresenter.DisplayTranfer((int)BaseRefTypeId, DateTime.Parse(GlobalVariable.PostedDate), false, string.Join(",", projectIds.ToArray()));
                }
        ...
        protected override void GridPurchaseShowEditor(object sender, EventArgs e)
        {
            ...
            if (view.FocusedColumn.FieldName == "FundStructureId" && view.ActiveEditor is GridLookUpEdit)
            {
