...
{
    public partial class FrmGLVouchersLastYear : FrmBaseVoucherList, IGLVouchersLastYearView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
        IFundStructuresView
    {
        public FrmGLVouchersLastYear()
        {
            InitializeComponent();
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _glVouchersLastYearPresenter.Display((int)RefType.GLVoucherLastYear);
        }
