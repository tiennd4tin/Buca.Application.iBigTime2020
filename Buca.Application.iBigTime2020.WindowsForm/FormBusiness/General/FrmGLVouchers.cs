...
{
    public partial class FrmGLVouchers : FrmBaseVoucherList, IGLVouchersView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
        IFundStructuresView
    {
        public FrmGLVouchers()
        {
            InitializeComponent();
            _glVouchersPresenter = new GLVouchersPresenter(this);
        ...
        #region Presenter
        private readonly GLVouchersPresenter _glVouchersPresenter;
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _glVouchersPresenter.Display((int)RefType.GLVoucher);
        }
        ...
        {
            var glVoucherModel = Model.GetGLVoucher(refId);

            bindingSourceDetail.DataSource = glVoucherModel.GLVoucherDetails;
            gridViewDetail.PopulateColumns(glVoucherModel.GLVoucherDetails);

            var columnsCollection = new List<XtraColumn>
                {
                    new XtraColumn {ColumnName = "RefDetailId", ColumnVisible = false},
                    new XtraColumn {ColumnName = "RefId", ColumnVisible = false},
                    new XtraColumn{ColumnName = "Description",ColumnVisible = true,ColumnWith = 250,ColumnCaption = "Diễn giải",ColumnPosition = 1,AllowEdit = true,},
                    ...
                    new XtraColumn{ColumnName = "BudgetSourceId",ColumnVisible = true,ColumnWith = 200,ColumnCaption = "Nguồn",ColumnPosition = 4,AllowEdit = true,RepositoryControl = _gridLookUpEditBudgetSource},
                    ...
                    new XtraColumn{ColumnName = "MethodDistributeId",ColumnVisible = false,ColumnWith = 160,ColumnCaption = "Cấp phát",ColumnPosition = 9,AllowEdit = true,RepositoryControl = _repositoryMethodDistributeId},
                    new XtraColumn{ColumnName = "CashWithDrawTypeId",ColumnVisible = true,ColumnWith = 160,ColumnCaption = "Nghiệp vụ",ColumnPosition = 10,AllowEdit = true,RepositoryControl = _gridLookUpEditCashWithdrawType},
                    ...
                    new XtraColumn{ColumnName = "FundStructureId",ColumnVisible = true,ColumnWith = 160,ColumnCaption = "Khoản chi",ColumnPosition = 11,AllowEdit = true,RepositoryControl = _gridLookUpEditFundStructure},
                     new XtraColumn{ColumnName = "ActivityId",ColumnVisible = true,ColumnWith = 160,ColumnCaption = "Công việc",ColumnPosition = 12,AllowEdit = true,RepositoryControl = _gridLookUpEditActivity},
        ...
        {
            new GLVoucherPresenter(null).Delete(PrimaryKeyValue);
        }
        #endregion
        ...
        public IList<GLVoucherModel> GLVouchers
        {
            set
            {
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "ParentRefId", ColumnVisible = false });
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "AdvancePaymentOrder", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "GLVoucherDetails", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "GLVoucherDetailTaxes", ColumnVisible = false });
                ColumnsCollection.Add(new XtraColumn { ColumnName = "GLVoucherDetailParalles", ColumnVisible = false });
        ...
        public IList<GLVoucherDetailModel> GLVoucherDetails { set; private get; }

        public IList<GLVoucherDetailTaxModel> GLVoucherDetailTaxes { get; private set; }
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.GLVoucher);
                return;
            }

            var model = (GLVoucherModel)obj;
