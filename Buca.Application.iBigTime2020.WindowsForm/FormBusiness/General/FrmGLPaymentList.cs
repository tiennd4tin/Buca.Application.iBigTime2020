...
{
    public partial class FrmGLPaymentList : FrmBaseVoucherList, IGLPaymentListsView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
        IFundStructuresView
    {
        public FrmGLPaymentList()
        {
            InitializeComponent();
            _glVoucherListsPresenter = new GLPaymentListsPresenter(this);
        ...
        #region Presenter
        private readonly GLPaymentListsPresenter _glVoucherListsPresenter;
        ...
        {
            var glVoucherModel = Model.GetGLPaymentListByRefId(refId);
            var value = glVoucherModel.GLPaymentListDetails ?? new List<GLPaymentListDetailModel>();
        ...
        {
            new GLPaymentListPresenter(null).Delete(PrimaryKeyValue);
        }
        #endregion
        ...
        public IList<GLPaymentListModel> GLPaymentListModel
        {
            set
            {
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "GLPaymentListDetails", ColumnVisible = false });
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.GLPaymentList);
                return;
            }

            var model = (GLPaymentListModel)obj;
