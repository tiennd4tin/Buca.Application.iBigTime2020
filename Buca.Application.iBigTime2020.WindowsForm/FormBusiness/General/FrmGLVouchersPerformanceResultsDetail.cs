...
namespace Buca.Application.iBigTime2020.WindowsForm.FormBusiness.General
{
    ...
    /// <seealso cref="Buca.Application.iBigTime2020.View.General.IGLVoucherPerformanceResultsView" />
    ...
    public partial class FrmGLVouchersPerformanceResultsDetail : FrmXtraBaseVoucherDetail, IGLVoucherPerformanceResultsView, IAccountingObjectsView,
                                              ...
                                              IInvoiceTypiesView, IBudgetExpensesView, IContractsView, ICapitalPlansView
    {
        ...
        private readonly GLVoucherPerformanceResultsPresenter _glVoucherPerformanceResultsPresenter;
        ...
        /// </summary>
        public FrmGLVouchersPerformanceResultsDetail()
        {
            InitializeComponent();
            ...
            _glVoucherPerformanceResultsPresenter = new GLVoucherPerformanceResultsPresenter(this);
        ...
        /// <summary>
        /// Handles the Load event of the FrmGLVouchersPerformanceResultsDetail control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void FrmGLVouchersPerformanceResultsDetail_Load(object sender, EventArgs e)
        {
            RefTypeUsingDisplayReport = BuCA.Enum.RefType.GLVoucherPerformanceResults;
        ...
        protected override void InitData()
        {
            ...
            if(ActionMode ==ActionModeVoucherEnum.AddNew) _glVoucherPerformanceResultsPresenter.DisplayTranfer((int)BaseRefTypeId,DateTime.Parse( GlobalVariable.PostedDate),false);
            else _glVoucherPerformanceResultsPresenter.Display(KeyValue, true, true);

            if (RefType == 0)
                RefType = (int)BuCA.Enum.RefType.GLVoucherPerformanceResults;
        }
        ...
        protected override string SaveData()
        {
            ...
            return result == DialogResult.OK ? _glVoucherPerformanceResultsPresenter.Save(true) : _glVoucherPerformanceResultsPresenter.Save(false);
        }
        ...
        {
            _glVoucherPerformanceResultsPresenter.Display(KeyValue, true, true);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="FrmGLVouchersPerformanceResultsDetail"/> is approved.
        /// </summary>
        /// <value>
                ...
                columnsCollection = new List<XtraColumn>
                    {
                        ...
                        new XtraColumn
                            {
                                ColumnName = "CreditAccountingObjectId",
                                ColumnVisible = false
                            },
                        new XtraColumn
                            {
...
new XtraColumn
        ...
        public IList<AccountModel> Accounts
        {
            set
            {
                try
                {
                    ...
                    var creditAccounts = debitAccounts;
                    var parallelAccounts = debitAccounts;
        ...
        //            _gridLookUpEditBankView = new GridView();
        //            _gridLookUpEditBankView.OptionsView.ColumnAutoWidth = false;
        //            _gridLookUpEditBank = new RepositoryItemGridLookUpEdit
        //            {
        //                NullText = "",
        //                View = _gridLookUpEditBankView,
        //                TextEditStyle = TextEditStyles.Standard,
        //            };
        //            _gridLookUpEditBank.View.OptionsView.ShowFilterPanelMode = ShowFilterPanelMode.Never;
        //            _gridLookUpEditBank.View.OptionsView.ShowIndicator = false;
        //            _gridLookUpEditBank.PopupFormSize = new Size(368, 150);

        //            _gridLookUpEditBank.View.BestFitColumns();
        //            _gridLookUpEditBank.TextEditStyle = TextEditStyles.Standard;
        //            _gridLookUpEditBank.AllowNullInput = DefaultBoolean.True;
        //            _gridLookUpEditBank.NullText = "";
        //            _gridLookUpEditBank.KeyDown += _gridLookUpEditBankView_KeyDown;

        //            _gridLookUpEditBank.DataSource = value;
        //            _gridLookUpEditBankView.PopulateColumns(value);
        //            var gridColumnsCollection = new List<XtraColumn>();
        ...
        //                ColumnWith = 250
        //            });
        //            gridColumnsCollection.Add(new XtraColumn { ColumnName = "BankAddress", ColumnVisible = false });
        ...
        //                if (column.ColumnVisible)
        //                {
        //                    _gridLookUpEditBankView.Columns[column.ColumnName].Caption = column.ColumnCaption;
        //                    _gridLookUpEditBankView.Columns[column.ColumnName].VisibleIndex = column.ColumnPosition;
        //                    _gridLookUpEditBankView.Columns[column.ColumnName].Width = column.ColumnWith;
        //                }
        //                else
        //                    _gridLookUpEditBankView.Columns[column.ColumnName].Visible = false;
        //            }
        //            _gridLookUpEditBank.DisplayMember = "BankAccount";
        //            _gridLookUpEditBank.ValueMember = "BankId";
        //        }
        //        catch (Exception ex)
        //        {
        //            XtraMessageBox.Show(ex.Message, ResourceHelper.GetResourceValueByName("ResExceptionCaption"),
