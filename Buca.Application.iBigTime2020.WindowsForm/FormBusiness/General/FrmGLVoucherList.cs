...
{
    public partial class FrmGLVoucherList : FrmBaseVoucherList, IGLVoucherListsView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
        IFundStructuresView
    {
        public FrmGLVoucherList()
        {
            InitializeComponent();
        ...
        {
            var glVoucherModel = Model.GetGLVoucherListByRefId(refId);
            if (glVoucherModel == null)
                return;
            var value = glVoucherModel.GlVoucherListDetails ?? new List<GLVoucherListDetailModel>();
            ...
            //XtraColumnCollectionHelper<GLVoucherListDetailModel>.ShowXtraColumnInGridView(columnsCollection, gridViewDetail);
        ...
        {
            new GLVoucherListPresenter(null).Delete(PrimaryKeyValue);
        }
        #endregion
        ...
        protected override void ChangeFormDetail()
        {
            ...
            if (obj == null)
            {
                SetFormDetail((int)RefType.GLVoucherList);
                return;
            }

            var model = (GLVoucherListModel)obj;
