...
{
    public partial class FrmGLVouchersEarlyYear : FrmBaseVoucherList, IGLVouchersEarlyYearView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
        IFundStructuresView
    {
        public FrmGLVouchersEarlyYear()
        {
            InitializeComponent();
            _glVouchersPresenter = new GLVouchersEarlyYearPresenter(this);
        ...
        #region Presenter
        private readonly GLVouchersEarlyYearPresenter _glVouchersPresenter;
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _glVouchersPresenter.Display((int)RefType.GLVoucherEarlyYear);
        }
