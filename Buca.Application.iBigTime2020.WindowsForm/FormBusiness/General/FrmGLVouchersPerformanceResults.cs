...
{
    public partial class FrmGLVouchersPerformanceResults : FrmBaseVoucherList, IGLVouchersPerformanceResultsView, IAccountingObjectsView, IBudgetSourcesView, IAccountsView,
        IBudgetChaptersView, IBudgetKindItemsView, IBudgetItemsView, ICashWithdrawTypesView, IBanksView, IActivitysView, IProjectsView,
        IFundStructuresView
    {
        public FrmGLVouchersPerformanceResults()
        {
            InitializeComponent();
            _glVouchersPerformanceResultsPresenter = new GLVouchersPerformanceResultsPresenter(this);
        ...
        #region Presenter
        private readonly GLVouchersPerformanceResultsPresenter _glVouchersPerformanceResultsPresenter;
        ...
        protected override void LoadDataIntoGrid()
        {
            ...
            _glVouchersPerformanceResultsPresenter.Display((int)RefType.GLVoucherPerformanceResults);
        }
            ...
            var columnsCollection = new List<XtraColumn>
                {
                    ...
                    new XtraColumn{ColumnName = "CashWithDrawTypeId",ColumnVisible = true,ColumnWith = 120,ColumnCaption = "Nghiệp vụ",ColumnPosition = 10,AllowEdit = true,RepositoryControl = _gridLookUpEditCashWithdrawType},
                    ...
                    new XtraColumn{ColumnName = "FundStructureId",ColumnVisible = true,ColumnWith = 120,ColumnCaption = "Khoản chi",ColumnPosition = 11,AllowEdit = true,RepositoryControl = _gridLookUpEditFundStructure},
        ...
        public IList<GLVoucherModel> GLVouchers
        {
            set
            {
                ...
                ColumnsCollection.Add(new XtraColumn { ColumnName = "BUTransferType", ColumnVisible = false });
