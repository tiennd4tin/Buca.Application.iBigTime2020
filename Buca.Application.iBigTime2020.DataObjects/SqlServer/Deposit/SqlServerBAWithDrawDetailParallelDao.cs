...
{
    /// <summary>
    /// Class SqlServerBAWithDrawDetailParallelDao.
    /// </summary>
    /// <seealso cref="Buca.Application.iBigTime2020.DataAccess.IEntitiesDao.Deposit.IBAWithDrawDetailParallelDao" />
    public class SqlServerBAWithDrawDetailParallelDao : IBAWithDrawDetailParallelDao
    {
        /// <summary>
        ...
        public string DeleteBAWithDrawDetailParallelById(string refId)
        {
            const string procedures = @"uspDelete_BAWithDrawDetailParallel_ByRefID";
        ...
        public List<BAWithDrawDetailParallelEntity> GetBAWithDrawDetailParallelByRefId(string refId)
        {
            const string procedures = @"uspGet_BAWithDrawDetailParallel_ByRefId";
            object[] parms = { "@RefId", refId };
        ...
        /// <returns>System.String.</returns>
        public string InsertBAWithDrawDetailParallel(BAWithDrawDetailParallelEntity withDrawDetail)
        {
            const string procedures = @"uspInsert_BAWithDrawDetailParallel";
        ...
        /// <param name="withDrawDetail">The with draw detail.</param>
        /// <returns>System.String.</returns>
        public string UpdateBAWithDrawDetailParallel(BAWithDrawDetailParallelEntity withDrawDetail)
        {
            const string procedures = @"uspUpdate_BAWithDrawDetailParallel";
        ...
        /// The make
        /// </summary>
        private static readonly Func<IDataReader, BAWithDrawDetailParallelEntity> Make = reader =>
            new BAWithDrawDetailParallelEntity
            {
        ...
        private static object[] Take(BAWithDrawDetailParallelEntity bAWithDrawDetailParallelEntity)
        {
            return new object[]
            {
