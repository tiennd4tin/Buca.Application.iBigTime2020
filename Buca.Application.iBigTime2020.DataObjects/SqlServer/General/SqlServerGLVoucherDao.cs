...
namespace Buca.Application.iBigTime2020.DataAccess.SqlServer.General
{
    ...
    /// </summary>
    public class SqlServerGLVoucherDao : IGLVoucherDao
    {
        /// <summary>
        ...
        {
            const string procedures = @"uspGet_GLVoucher_ByBUTransferRefID";
            object[] parms = { "@BUTransferRefID", buTransferRefId };
            return Db.Read(procedures, true, Make, parms);
        }
