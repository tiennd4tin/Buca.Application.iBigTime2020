/***********************************************************************
 * <copyright file="OpeningCommitmentModel.cs" company="BUCA JSC">
...
{
    /// <summary>
    /// Class OpeningCommitmentModel.
    /// </summary>
    public class OpeningCommitmentModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpeningCommitmentModel"/> class.
        /// </summary>
        public OpeningCommitmentModel()
        {
            OpeningCommitmentDetails = new List<OpeningCommitmentDetailModel>();
        }
        ...
        public IList<OpeningCommitmentDetailModel> OpeningCommitmentDetails { get; set; }
