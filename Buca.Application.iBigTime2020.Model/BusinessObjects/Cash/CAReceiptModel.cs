...
namespace Buca.Application.iBigTime2020.Model.BusinessObjects.Cash
{
    ...
    /// </summary>
    public class CAReceiptModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CAReceiptModel"/> class.
        /// </summary>
        public CAReceiptModel()
        {
            CAReceiptDetails = new List<CAReceiptDetailModel>();
            CAReceiptDetailTaxes = new List<CAReceiptDetailTaxModel>();
            CAReceiptDetailParallels = new List<CAReceiptDetailParallelModel>();
        }
        ...
        public IList<CAReceiptDetailModel> CAReceiptDetails { get; set; }

        /// <summary>
        /// Gets or sets the ca receipt detail taxes.
        /// </summary>
        /// <value>The ca receipt detail taxes.</value>
        public IList<CAReceiptDetailTaxModel> CAReceiptDetailTaxes { get; set; }

        /// <summary>
        /// Gets or sets the ca receipt detail parallels.
        /// </summary>
        /// <value>The ca receipt detail parallels.</value>
        public IList<CAReceiptDetailParallelModel> CAReceiptDetailParallels { get; set; }
