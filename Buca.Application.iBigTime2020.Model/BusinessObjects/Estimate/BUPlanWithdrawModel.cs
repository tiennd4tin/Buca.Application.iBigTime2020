/***********************************************************************
 * <copyright file="BUPlanWithdrawModel.cs" company="BUCA JSC">
...
{
    public class BUPlanWithdrawModel
    {
        public BUPlanWithdrawModel()
        {
            BUPlanWithdrawDetails = new List<BUPlanWithdrawDetailModel>();
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this is posted.
        /// </summary>
        ...
        public IList<BUPlanWithdrawDetailModel> BUPlanWithdrawDetails { get; set; }
