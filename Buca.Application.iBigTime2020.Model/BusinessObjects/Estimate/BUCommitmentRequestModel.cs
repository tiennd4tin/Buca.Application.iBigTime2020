/***********************************************************************
 * <copyright file="BUCommitmentRequestModel.cs" company="BUCA JSC">
...
{
    /// <summary>
    /// Class BUCommitmentRequestModel.
    /// </summary>
    public class BUCommitmentRequestModel
    {
        public BUCommitmentRequestModel()
        {
            BUCommitmentRequestDetails = new List<BUCommitmentRequestDetailModel>();
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="BUCommitmentRequestModel"/> is posted.
        /// </summary>
        ...
        public IList<BUCommitmentRequestDetailModel> BUCommitmentRequestDetails { get; set; }
