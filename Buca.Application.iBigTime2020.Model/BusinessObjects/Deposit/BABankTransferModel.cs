...
{
    /// <summary>
    /// Class BABankTransferModel.
    /// </summary>
    public class BABankTransferModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BABankTransferModel"/> class.
        /// </summary>
        public BABankTransferModel()
        {
            BABankTransferDetail = new List<BABankTransferDetailModel>();
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="BABankTransferModel"/> is posted.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the ba bank transfer detail.
        /// </summary>
        /// <value>The ba bank transfer detail.</value>
        public IList<BABankTransferDetailModel> BABankTransferDetail { get; set; }

        /// <summary>
        /// Gets or sets the ba bank transfer detail parallels.
        /// </summary>
        /// <value>The ba bank transfer detail parallels.</value>
        public IList<BABankTransferDetailParallelModel> BABankTransferDetailParallels { get; set; }
    }
}
