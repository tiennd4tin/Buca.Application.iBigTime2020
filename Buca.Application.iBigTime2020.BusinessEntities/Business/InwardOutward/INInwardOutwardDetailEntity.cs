...
namespace Buca.Application.iBigTime2020.BusinessEntities.Business.InwardOutward
{
    ...
    /// </summary>
    public class INInwardOutwardDetailEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="INInwardOutwardDetailEntity"/> class.
        /// </summary>
        public INInwardOutwardDetailEntity()
        {
