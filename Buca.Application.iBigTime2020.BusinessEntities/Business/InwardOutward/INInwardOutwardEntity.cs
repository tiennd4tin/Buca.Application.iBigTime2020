...
namespace Buca.Application.iBigTime2020.BusinessEntities.Business.InwardOutward
{
    ...
    /// </summary>
    public class INInwardOutwardEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="INInwardOutwardEntity"/> class.
        /// </summary>
        public INInwardOutwardEntity()
        {
        ...
        public IList<INInwardOutwardDetailEntity> InwardOutwardDetails { get; set; }
        ///<summary>
        ///Gets or sets the inward outward detail parallel
        /// </summary>
        /// <value>the inward outward details.</value>
        public IList<INInwardOutwardDetailParallelEntity> INInwardOutwardDetailParallels { get; set; }
        /// <summary>
