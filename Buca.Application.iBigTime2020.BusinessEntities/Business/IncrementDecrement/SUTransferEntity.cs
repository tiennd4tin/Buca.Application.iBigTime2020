...
namespace Buca.Application.iBigTime2020.BusinessEntities.Business.IncrementDecrement
{
    ...
    /// SUTransferEntity
    /// </summary>
    public class SUTransferEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SUTransferEntity"/> class.
        /// </summary>
        public SUTransferEntity()
        {
        ...
        /// </value>
        public IList<SUTransferDetailEntity> SUTransferDetails { get; set; }
    }
}
