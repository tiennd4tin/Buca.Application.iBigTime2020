...
namespace Buca.Application.iBigTime2020.BusinessEntities.Business.IncrementDecrement
{
    ...
    /// SUTransferEntity
    /// </summary>
    public class FAAdjustmentEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FAAdjustmentEntity"/> class.
        /// </summary>
        public FAAdjustmentEntity()
        {
            FAAdjustmentDetails = new List<FAAdjustmentDetailEntity>();
            FAAdjustmentDetailParallels = new List<FAAdjustmentDetailParallelEntity>();
        }
        ...
        /// </value>
        public IList<FAAdjustmentDetailEntity> FAAdjustmentDetails { get; set; }
        public IList<FAAdjustmentDetailParallelEntity> FAAdjustmentDetailParallels { get; set; }
