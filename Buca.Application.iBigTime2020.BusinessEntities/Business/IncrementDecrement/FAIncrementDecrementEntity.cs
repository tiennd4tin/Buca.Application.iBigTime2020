/***********************************************************************
 * <copyright file="FAIncrementDecrementEntity.cs" company="BUCA JSC">
...
namespace Buca.Application.iBigTime2020.BusinessEntities.Business.IncrementDecrement
{
    ...
    public class FAIncrementDecrementEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FAIncrementDecrementEntity"/> class.
        /// </summary>
        public FAIncrementDecrementEntity()
        {
            FAIncrementDecrementDetails = new List<FAIncrementDecrementDetailEntity>();
        }
        ...
        /// </value>
        public IList<FAIncrementDecrementDetailEntity> FAIncrementDecrementDetails { get; set; }
    }
}