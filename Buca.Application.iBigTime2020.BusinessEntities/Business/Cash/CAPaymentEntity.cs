...
{
    /// <summary>
    /// Class CAPaymentEntity.
    /// </summary>
    /// <seealso cref="Buca.Application.iBigTime2020.BusinessEntities.BusinessEntities" />
    public class CAPaymentEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CAPaymentEntity"/> class.
        /// </summary>
        public CAPaymentEntity()
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="CAPaymentEntity"/> is posted.
        /// </summary>
        ...
        public IList<CAPaymentDetailEntity> CaPaymentDetails { get; set; }

        /// <summary>
        /// Gets or sets the ca payment detail taxes.
        /// </summary>
        /// <value>The ca payment detail taxes.</value>
        public IList<CAPaymentDetailTaxEntity> CaPaymentDetailTaxes { get; set; }

        /// <summary>
        /// Gets or sets the ca payment detail purchases.
        /// </summary>
        /// <value>The ca payment detail purchases.</value>
        public IList<CAPaymentDetailPurchaseEntity> CAPaymentDetailPurchases { get; set; }

        /// <summary>
        /// Gets or sets the ca payment detail fixed assets.
        /// </summary>
        /// <value>The ca payment detail fixed assets.</value>
        public IList<CAPaymentDetailFixedAssetEntity> CAPaymentDetailFixedAssets { get; set; }

        /// <summary>
        /// Gets or sets the ca payment detail parallels.
        /// </summary>
        /// <value>The ca payment detail parallels.</value>
        public IList<CAPaymentDetailParallelEntity> CAPaymentDetailParallels { get; set; }
