...
namespace Buca.Application.iBigTime2020.BusinessEntities.Business.Cash
{
    ...
    /// </summary>
    public class CAPaymentDetailParallelEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CAPaymentDetailParallelEntity" /> class.
        /// </summary>
        public CAPaymentDetailParallelEntity()
        {
