...
namespace Buca.Application.iBigTime2020.BusinessEntities.Business.PUInvoice
{
    public class PUInvoiceEntity : BusinessEntities
    {
        public PUInvoiceEntity()
        {
            PUInvoiceDetailFixedAssets = new List<PUInvoiceDetailFixedAssetEntity>();
        }
        ...
        public List<SelectItemEntity> ParallelEntities { get; set; }
        ...
        public IList<PUInvoiceDetailFixedAssetEntity> PUInvoiceDetailFixedAssets { get; set; }
    }
}
