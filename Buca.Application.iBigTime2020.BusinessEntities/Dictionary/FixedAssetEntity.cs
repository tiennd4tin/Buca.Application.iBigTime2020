...
namespace Buca.Application.iBigTime2020.BusinessEntities.Dictionary
{
    ...
    public class FixedAssetEntity : BusinessEntities
    {
        ...
        public IList<FixedAssetDetailAccessoryEntity> FixedAssetDetailAccessories { get; set; }
        public string FundStructureId { get; set; }

        public IList<FixedAssetVoucherAttachEntity> FixedAssetVoucherAttachs { get; set; }

        /// <summary>
        /// RefId of OpeningFixedAssetEntity
        /// </summary>
        public string RefId { get; set; }

        /// <summary>
        /// RefType of OpeningFixedAssetEntity
        /// </summary>
