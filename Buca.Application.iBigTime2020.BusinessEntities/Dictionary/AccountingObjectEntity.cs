...
namespace Buca.Application.iBigTime2020.BusinessEntities.Dictionary
{
    ...
    public class AccountingObjectEntity : BusinessEntities
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountingObjectEntity"/> class.
        /// </summary>
        public AccountingObjectEntity() 
        {
           // AddRule(new ValidateLength("AccountingObjectCode", 1, 50));
           // AddRule(new ValidateLength("AccountingObjectName", 1, 255));
        }
        ...
        ///// <param name="bankAcount">The bank acount.</param>
        ///// <param name="bankId">The bank identifier.</param>
        ///// <param name="contactName">Name of the contact.</param>
        ///// <param name="contactAddress">The contact address.</param>
        ///// <param name="contactIdNumber">The contact identifier number.</param>
        ///// <param name="issueDate">The issue date.</param>
        ///// <param name="issueAddress">The issue address.</param>
        //public AccountingObjectEntity(int accountingObjectId, string accountingObjectCode,string accountingObjectCategoryID, string accountingObjectName, int? type, string fullName, string address, string taxCode, string bankAcount, 
        //    int? bankId, string contactName, string contactAddress, string contactIdNumber, DateTime? issueDate, string issueAddress)
        //    :this()
        //{
        ...
        //}
        public List<BankEntity> AccountingObjectBanks { get; set; }
        /// <summary>
