...
namespace Buca.Application.iBigTime2020.Presenter.Estimate
{
    ...
    public class BUPlanWithdrawTransferInsurrancesPresenter : Presenter<IBUPlanWithdrawTransferInsurrancesView>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CAReceiptsPresenter" /> class.
        /// </summary>
        /// <param name="view">The view.</param>
        public BUPlanWithdrawTransferInsurrancesPresenter(IBUPlanWithdrawTransferInsurrancesView view)
            : base(view)
        {
        }
