...
{
    public class GLVoucherPerformanceResultsPresenter : Presenter<IGLVoucherPerformanceResultsView>
    {
        public GLVoucherPerformanceResultsPresenter(IGLVoucherPerformanceResultsView view) : base(view)
        {
        }
        ...
        public void DisplayTranfer(int RefType, DateTime sysDate, bool hasTax)
        {
            var glVoucher = Model.GetGLVoucherTranfer(RefType, sysDate, hasTax) ?? new GLVoucherModel();
