...
namespace Buca.Application.iBigTime2020.Presenter.General
{
    ...
    /// GLVouchersPresenter
    /// </summary>
    public class GLVouchersEarlyYearPresenter : Presenter<IGLVouchersEarlyYearView>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GLVouchersPresenter"/> class.
        /// </summary>
        /// <param name="view">The view.</param>
        public GLVouchersEarlyYearPresenter(IGLVouchersEarlyYearView view) : base(view)
        {
        }
