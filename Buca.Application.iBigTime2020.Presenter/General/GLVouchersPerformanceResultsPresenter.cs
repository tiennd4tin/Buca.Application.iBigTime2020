...
namespace Buca.Application.iBigTime2020.Presenter.General
{
    ...
    /// GLVouchersPresenter
    /// </summary>
    public class GLVouchersPerformanceResultsPresenter : Presenter<IGLVouchersPerformanceResultsView>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GLVouchersPresenter"/> class.
        /// </summary>
        /// <param name="view">The view.</param>
        public GLVouchersPerformanceResultsPresenter(IGLVouchersPerformanceResultsView view) : base(view)
        {
        }
