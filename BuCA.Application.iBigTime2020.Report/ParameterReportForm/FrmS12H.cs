...
namespace BuCA.Application.iBigTime2020.Report.ParameterReportForm
{
    ...
    /// Class FrmS12H.
    /// </summary>
    public partial class FrmS12H : FrmXtraBaseParameter, IBudgetChaptersView, IBudgetKindItemsView, IBanksView, IAccountsView
    {
        /// <summary>
        ...
        public IList<BankModel> Banks
        {
            set
            {
                ...
                columnsCollection.Add(new XtraColumn { ColumnName = "IsActive", ColumnVisible = false });
                columnsCollection.Add(new XtraColumn { ColumnName = "Used", ColumnVisible = false });
                foreach (var column in columnsCollection)
                {
                    if (column.ColumnVisible)
                    {
                        ...
                        cboBankId.Properties.Columns[column.ColumnName].Width = column.ColumnWith;
                    }
                    else
