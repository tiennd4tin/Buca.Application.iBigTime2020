...
namespace BuCA.Application.iBigTime2020.Report.ParameterReportForm
{
    ...
    /// Class FrmS101H.
    /// </summary>
    public partial class FrmS101H : FrmXtraBaseParameter, IBudgetSourcesView, IBudgetChaptersView, IBudgetKindItemsView, IAccountsView, IProjectsView
    {
        #region Presenter
        /// <summary>
        ...
        public string AccountNumber
        {
            get
            {
                if (cboAccountNumber.EditValue.ToString() == "<<Tổng hợp>>" || cboAccountNumber.EditValue.ToString() == "<<Tất cả>>")
                {
                    return null;
                }
        ...
        /// <summary>
        /// Gets a value indicating whether this instance is summary view.
        /// </summary>
        /// <value><c>true</c> if this instance is summary view; otherwise, <c>false</c>.</value>
        ...
        public IList<AccountModel> Accounts
        {
            set
            {
                _accountModel = value.Where(x => x.AccountNumber.StartsWith("008") || x.AccountNumber.StartsWith("009")).ToList();
                ...
                result.AddRange(value.Where(x => x.AccountNumber.StartsWith("008") || x.AccountNumber.StartsWith("009")).ToList());
