/***********************************************************************
 * <copyright file="IBUCommitmentRequestView.cs" company="BUCA JSC">
...
{
    /// <summary>
    /// Interface IBUCommitmentRequestView
    /// </summary>
    /// <seealso cref="Buca.Application.iBigTime2020.View.IView" />
   public interface IBUCommitmentRequestView : IView
    {
        /// <summary>
        ...
        IList<BUCommitmentRequestDetailModel> BUCommitmentRequestDetails { get; set; }
    }
}
